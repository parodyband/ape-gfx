...
main :: proc() {
	...
	expect_error(&ctx_leak, "gfx.shutdown: leaked resources: buffers=1 images=0 views=0 samplers=0 shaders=0 pipelines=0 compute_pipelines=0 binding_group_layouts=0 binding_groups=0")
