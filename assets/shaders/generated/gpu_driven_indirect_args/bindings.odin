...
SIZE_ComputeUniforms :: 16
ALIGN_ComputeUniforms :: 16
#assert(size_of(ComputeUniforms) == SIZE_ComputeUniforms)
OFFSET_ComputeUniforms_quad_count :: 0
SIZE_ComputeUniforms_quad_count :: 4
#assert(offset_of(ComputeUniforms, quad_count) == OFFSET_ComputeUniforms_quad_count)
OFFSET_ComputeUniforms_vertices_per_quad :: 4
SIZE_ComputeUniforms_vertices_per_quad :: 4
#assert(offset_of(ComputeUniforms, vertices_per_quad) == OFFSET_ComputeUniforms_vertices_per_quad)
OFFSET_ComputeUniforms_pad0 :: 8
SIZE_ComputeUniforms_pad0 :: 4
#assert(offset_of(ComputeUniforms, pad0) == OFFSET_ComputeUniforms_pad0)
OFFSET_ComputeUniforms_pad1 :: 12
SIZE_ComputeUniforms_pad1 :: 4
...
VK_CS_UB_ComputeUniforms :: 1
VK_CS_UB_ComputeUniforms_SPACE :: 0
...
set_view_indirect_args :: proc(bindings: ^gfx.Bindings, view: gfx.View) {
	if bindings == nil {
		return
	}
	bindings.views[GROUP_0][VIEW_indirect_args] = view
}

set_group_view_indirect_args :: proc(group: ^gfx.Binding_Group_Desc, view: gfx.View) {
	if group == nil {
		return
	}
	group.views[VIEW_indirect_args] = view
}

apply_uniform_ComputeUniforms :: proc(ctx: ^gfx.Context, value: ^$T) -> bool {
	#assert(size_of(T) == SIZE_ComputeUniforms)
	return gfx.apply_uniform(ctx, GROUP_0, UB_ComputeUniforms, value)
}
