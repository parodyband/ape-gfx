...
main :: proc() {
	...
	textured_cube_shader.set_view_material_ape_texture(&bindings, texture_view)
	textured_cube_shader.set_sampler_material_ape_sampler(&bindings, sampler)
