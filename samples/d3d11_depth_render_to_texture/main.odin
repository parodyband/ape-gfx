...
main :: proc() {
	...
	depth_visualize_shader.set_view_ape_texture(&texture_bindings, offscreen_sample_view)
	depth_visualize_shader.set_sampler_ape_sampler(&texture_bindings, sampler)
